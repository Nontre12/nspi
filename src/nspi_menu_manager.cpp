...
nspi::MenuManager::MenuManager::MenuManager(Pad &pad) : pad(pad) { this->init(); }

nspi::MenuManager::MenuManager::~MenuManager() { this->clean(); }
...
void nspi::MenuManager::enter(nspi::Menu *menu) { this->menus.push(menu); }
